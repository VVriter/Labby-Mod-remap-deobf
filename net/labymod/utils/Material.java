...
public enum Material
{
    ...
    public ain getItem() {
        return ain.c(this.id);
    }
    
    public aip createItemStack() {
        return new aip((this.getItem() == null) ? Material.APPLE.getItem() : this.getItem());
    }
    
    public aip createItemStack(final int amount, final int meta) {
        return new aip(this.getItem(), amount, meta);
    }
}
