...
public class PartyResponseHandler implements PartyListener
{
    ...
    public void onSystemMessage(final PartyActionTypes.Message type, final String[] args) {
        System.out.println(type.getKey() + " (" + Arrays.toString(args) + ")");
    ...
    public void onMemberList(final UUID partyId, final PartyMember[] partyMembers) {
        ...
        if (partyMembers.length > 1) {
            this.partySystem.chatUserDummy = new ChatUser((GameProfile)null, UserStatus.ONLINE, "", (ServerInfo)null, 0, System.currentTimeMillis(), 0L, "", System.currentTimeMillis(), System.currentTimeMillis(), partyMembers.length, true);
