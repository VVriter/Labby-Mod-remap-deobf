...
public class AutoTextKeyBinds
{
    ...
    public static class AutoText
    {
        ...
        public boolean isPressed() {
            ...
            if (serverData == null) {
                return bib.z().E() && this.serverAddress.equals("singleplayer");
            }
            return this.serverAddress == null || this.serverAddress.isEmpty() || ModUtils.getProfileNameByIp(serverData.b).equalsIgnoreCase(this.serverAddress);
        }
