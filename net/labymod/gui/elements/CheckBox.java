...
public class CheckBox extends bir
{
    ...
    public void drawCheckbox(final int mouseX, final int mouseY) {
        ...
        a(this.x, this.y, this.x + this.width, this.y + this.height, ModColor.toRGB(0, 0, 0, 255));
        a(this.x + 1, this.y + 1, this.x + this.width - 1, this.y + this.height - 1, ModColor.toRGB(170, 170, 170, 255));
        a(this.x + 2, this.y + 2, this.x + this.width - 2, this.y + this.height - 2, ModColor.toRGB(hover ? 100 : 120, hover ? 100 : 120, hover ? 100 : 120, 255));
        ...
        if (value == EnumCheckBoxValue.ENABLED) {
            ...
            a(this.x + this.width / 3, this.y + this.height / 3, this.x + this.width - this.width / 3 + 1, this.y + this.height - this.height / 3 + 1, ModColor.toRGB(0, 100, 0, 255));
            a(this.x + this.width / 3 - 1, this.y + this.height / 3 - 1, this.x + this.width - this.width / 3, this.y + this.height - this.height / 3, ModColor.toRGB(0, 150, 0, 255));
        }
        if (this.hasDefault && this.currentValue == EnumCheckBoxValue.DEFAULT) {
            if (this.getValue() == EnumCheckBoxValue.ENABLED) {
                a(this.x + 2, this.y + 2, this.x + this.width - 2, this.y + this.height - 2, ModColor.toRGB(0, 150, 0, 155));
            }
    ...
    public enum EnumCheckBoxValue
    {
        ...
        private EnumCheckBoxValue(final float pitch) {
            this.pitch = pitch;
        }
