...
public class ScarfImageHandler extends CosmeticImageHandler
{
    public ScarfImageHandler(final String userAgent) {
        super(userAgent, "labymodscarf", false);
    }
    
    public UserTextureContainer getContainer(final User user) {
        return user.getScarfContainer();
    }
